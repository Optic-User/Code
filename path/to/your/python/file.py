...
class Game:
    def __init__(self):
        ...
        self.story_text = tk.Text(self.root, width=50, height=10, bg=dark_color, fg=light_color, font=modern_font, padx=10, pady=10)
        self.story_text.pack()

        self.attack_button = tk.Button(self.root, text="Attack", command=self.attack, bg=dark_color, fg=light_color, font=modern_font, relief='flat', padx=10, pady=10)
        self.attack_button.pack()

        self.defend_button = tk.Button(self.root, text="Defend", command=self.defend, bg=dark_color, fg=light_color, font=modern_font, relief='flat', padx=10, pady=10)
